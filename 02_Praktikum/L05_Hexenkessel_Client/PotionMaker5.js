...
(function (L05_PotionMaker) {
    ...
    async function handleLoad(_event) {
        ...
        L05_PotionMaker.generateContent(data);
    ...
    async function sendRecipe(_event) {
        ...
        await fetch("PotionMaker5.html?" + descriptionQuery.toString() + "&" + instructionQuery.toString());
        alert("Recipe successfully sent to Hogwarts!");
    }
...
//# sourceMappingURL=PotionMaker5.js.map